...
namespace ITInventory.Migrations
{
    ...
    [Migration("20210418075734_inv id remove")]
    partial class invidremove
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITInventory.Models.CheckOut", b =>
                {
                    ...
                    b.Property<string>("HardwareItemName")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("CheckOutTime", "InventoryName", "CustomerId");

                    b.HasIndex("ApproverId");

                    b.HasIndex("CustomerId");

                    b.HasIndex("HardwareItemName");
            ...
            modelBuilder.Entity("InventoryItemReceipt", b =>
                {
                    b.Property<string>("InventoryItemsName")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ReceiptsDocumentID")
                        .HasColumnType("int");

                    b.HasKey("InventoryItemsName", "ReceiptsDocumentID");
            ...
            modelBuilder.Entity("ITInventory.Models.CheckOut", b =>
                {
                    ...
                    b.HasOne("ITInventory.Models.HardwareItem", null)
                        .WithMany("CheckOuts")
                        .HasForeignKey("HardwareItemName");
            ...
            modelBuilder.Entity("InventoryItemReceipt", b =>
                {
                    b.HasOne("ITInventory.Models.InventoryItem", null)
                        .WithMany()
                        .HasForeignKey("InventoryItemsName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
