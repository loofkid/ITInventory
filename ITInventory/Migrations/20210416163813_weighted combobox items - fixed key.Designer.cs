...
namespace ITInventory.Migrations
{
    ...
    [Migration("20210416163813_weighted combobox items - fixed key")]
    partial class weightedcomboboxitemsfixedkey
    {
            ...
            modelBuilder.Entity("ITInventory.Models.HardwareItem", b =>
                {
                    ...
                    b.HasIndex("PhysicalLocationName");
            ...
            modelBuilder.Entity("ITInventory.Models.HardwareItem", b =>
                {
                    ...
                    b.HasOne("ITInventory.Models.PhysicalLocation", "PhysicalLocation")
                        .WithMany()
                        .HasForeignKey("PhysicalLocationName");
            ...
            modelBuilder.Entity("ITInventory.Models.Category", b =>
                {
                    b.HasOne("ITInventory.Models.WeightedComboBoxItem", null)
                        .WithOne()
                        .HasForeignKey("ITInventory.Models.Category", "Name")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ITInventory.Models.ItemModel", b =>
                {
                    b.HasOne("ITInventory.Models.WeightedComboBoxItem", null)
                        .WithOne()
                        .HasForeignKey("ITInventory.Models.ItemModel", "Name")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ITInventory.Models.Manufacturer", b =>
                {
                    b.HasOne("ITInventory.Models.WeightedComboBoxItem", null)
                        .WithOne()
                        .HasForeignKey("ITInventory.Models.Manufacturer", "Name")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ITInventory.Models.PhysicalLocation", b =>
                {
                    b.HasOne("ITInventory.Models.WeightedComboBoxItem", null)
                        .WithOne()
                        .HasForeignKey("ITInventory.Models.PhysicalLocation", "Name")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
